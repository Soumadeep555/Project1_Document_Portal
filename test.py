...
def test_document_ingestion_and_rag():
    try:
        test_files = [
            ...
            "data\\multi_doc_chat\\Getting Started with AI Hacking Part 1 - Black Hills Information Security, Inc..pdf",
            "data\\multi_doc_chat\\Lakera_AI_Prompt_Injection_Attacks_Handbook_v2-min.pdf",
